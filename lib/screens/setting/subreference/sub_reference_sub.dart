...
import 'package:malikopal/screens/setting/subreference/sub_reference_post.dart';
          ...
          children: [
            AppBar(
              ...
              title: Text(
                "Sub Reference",
                style: TextStyle(
                    color: model.isDarkTheme ? Colors.white : Colors.grey,
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Image.asset(
                      ...
                      color:
                          model.isDarkTheme ? Colors.white : Color(0xff8E8E8E),
                      // Colors.white,
                      height: 17.h,
                      width: 20.w,
                    ),
      ...
      child: Row(
        ...
        children: [
          ...
          InkWell(
            ...
            child: SubRefeTile(
              textFiled: "Capital\nHistory",
              url: "assets/newassets/PaymentHistoryView.svg",
            ),
          ),
          Padding(
    ...
    return SizedBox(
      ...
      child: Column(
        children: [
          SvgPicture.asset(
            url,
            color: model.isDarkTheme ? Colors.white : Color(0xff8E8E8E),
          ),
          SizedBox(
            height: 6,
          ),
