...
import 'package:malikopal/model/capital_history_responce_model.dart';
    ...
    return Card(
      ...
      child: Padding(
        padding: EdgeInsets.only(
            top: widget.topPadding ?? 9.5.h,
            bottom: widget.bottomPadding ?? 9.5.h,
            right: 10.h,
            left: widget.Prefixtext.isNotEmpty ? 25.h : 10.h),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          ...
          children: [
            if (widget.Prefixtext!.isNotEmpty)
              ...
              SizedBox.shrink(),
            if (widget.Prefixtext.isNotEmpty) SizedBox(width: 10),
            Expanded(
              child: TextField(
    ...
    await showMonthYearPicker(
      ...
      if (new_value != null) {
        setState(() {
          ...
          var data = PaymentHistoryReqDataModel(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              suffixIcon: GestureDetector(
                onTap: () {
                  var resq = bloc!.GetReferenceIn(HistoryReqDataModel(
...
class CustomTopBar extends StatelessWidget {
  const CustomTopBar(
      {Key? key, required this.topbartitle, this.action, this.isProfileUpdate})
      : super(key: key);
