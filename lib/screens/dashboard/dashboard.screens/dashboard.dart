  ...
  void initState() {
    ...
    SessionData().getUserProfile().then((value) {
      ...
      if (isRefrenceAllowed) {
        ...
        grid_menu_icons.insert(9, 'assets/svg/ref_in.png');
      ...
      if (IsSubReferenceAllowed) {
        ...
        grid_menu_icons.insert(10, 'assets/svg/subRefenceIn.png');
                    ...
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Image.asset(grid_menu_icons[index],
                                height:
